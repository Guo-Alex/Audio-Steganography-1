...
[y,fs] = audioread('F:\Desktop\ICT\Sem 6\ISS\Steganography\LSB-Coding\audio_in\test.wav');
    y = y(:,1);
    dt = 1/fs;
...
[y,fs] = audioread('F:\Desktop\ICT\Sem 6\ISS\Steganography\LSB-Coding\audio_in\test_stego.wav');
    y = y(:,1);
    dt = 1/fs;
    t = 0:dt:(length(y)*dt)-dt;
    figure;
